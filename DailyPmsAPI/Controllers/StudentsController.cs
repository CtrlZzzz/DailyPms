...
namespace DailyPmsAPI.Controllers
{
    ...
    public class StudentsController : ControllerBase
    {
        ...
        /// </summary>
        /// <param name="schoolId" example="100000000000000000000004">The ID from the school from which you want to get all students</param>
        /// <returns></returns>
        /// <response code="200">A list of students is returned</response>
        ...
        /// </summary>
        /// <param name="id" example="300000000000000000000033">The ID from the student to get</param>
        /// <returns></returns>
        ...
        /// </summary>
        /// <param name="name" example="Grégoire">The name of the student to get</param>
        /// <returns></returns>
        ...
        /// Update a student
        /// </summary>
        /// <param name="id" example="300000000000000000000033">The ID from the student to update</param>
